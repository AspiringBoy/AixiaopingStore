package com.axp.axpseller.models.config;
...
public class LocalConfig {
    ...
    private boolean openNewMsgNotice = true;
    ...
    public boolean isOpenNewMsgNotice() {
        return openNewMsgNotice;
    }

    public void setOpenNewMsgNotice(boolean openNewMsgNotice) {
        this.openNewMsgNotice = openNewMsgNotice;
    }
