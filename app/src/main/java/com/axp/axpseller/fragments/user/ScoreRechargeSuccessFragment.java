...
public class ScoreRechargeSuccessFragment extends BaseFragment {
    ...
    private void handleFinish() {
        if (!"收取积分".equals(title)) {
            getSupportApplication().removeActivitys(ScoreRechargeOnlineActivity.class, ScoreRechargeOffLineActivity.class, SendScoreActivity.class, SendScoreDtActivity.class);
            getActivity().finish();
        }else {
