 ...
 */
public class MyApplyAdapter extends SuperRecyclerViewAdapter<Apply, MyApplyAdapter.MyApplysListViewHoler> {

    public MyApplyAdapter(Context context, DataList<Apply> dataList) {
    ...
    public void onSuperBindViewHolder(MyApplysListViewHoler holder, int position) {
        Apply apply = mList.get(position);
