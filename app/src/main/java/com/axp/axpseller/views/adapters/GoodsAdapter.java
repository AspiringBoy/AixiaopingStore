...
import com.axp.axpseller.activitys.mall.GoodsCommentListActivity;
import com.axp.axpseller.core.RecyclerViewModel;
import com.axp.axpseller.fragments.goods.GoodsFragment;
...
import com.axp.axpseller.views.adapters.viewholder.GoodsCommentItemViewHolder;
import com.axp.axpseller.views.adapters.viewholder.GoodsCommentTitleViewHolder;
import com.axp.axpseller.views.goods.SpecView;
import com.axp.axpseller.views.widget.AddAndSubtractView;
...
public class GoodsAdapter extends SuperRecyclerViewAdapter<RecyclerViewModel, RecyclerView.ViewHolder> {
    ...
    public GoodsAdapter(Context context, DataList<RecyclerViewModel> list) {
        super(context, list);
    }
    ...
    public RecyclerView.ViewHolder onSuperCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_INFO:
                viewHolder = new GoodsInfoViewHolder(mContext, parent);
                break;
...
class GoodsInfoViewHolder extends RecyclerView.ViewHolder {
    ...
    public GoodsInfoViewHolder(Context context,ViewGroup parent) {
    ...
    public void bindView(Goods goods) {
        ...
        tvSalesVolume.setText(mGoods.getSalesVolume());
