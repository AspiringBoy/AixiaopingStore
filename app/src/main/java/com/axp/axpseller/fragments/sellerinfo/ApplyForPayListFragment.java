 ...
 */
public class ApplyForPayListFragment extends BaseFragment{
    @BindView(R.id.list)
    ...
    private void getApply() {
        ...
        RXUtils.request(getActivity(), request, "getwithdrawalApplyForPay", new SupportSubscriber<Response<DataList<Apply>>>() {
