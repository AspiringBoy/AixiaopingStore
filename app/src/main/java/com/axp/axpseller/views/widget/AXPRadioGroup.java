package com.axp.axpseller.views.widget;
...
public class AXPRadioGroup extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public AXPRadioGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public AXPRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(AXPRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(AXPRadioGroup.class.getName());
    }
