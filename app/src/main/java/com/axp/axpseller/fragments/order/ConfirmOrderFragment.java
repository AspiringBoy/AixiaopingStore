...
import com.axp.axpseller.activitys.mall.GoodsActivity;
...
import com.axp.axpseller.models.bean.ConfirmOrderBean;
import com.axp.axpseller.models.bean.PayOrderBean;
...
import com.axp.axpseller.utils.ReflectionUtils;
        ...
        RXUtils.request(getActivity(), request, "payOrders", new SupportSubscriber<Response<PayModel>>() {
            ...
            public void onNext(Response<PayModel> payOrderBean) {
                ...
                if (Constants.PAY_ALIPAY.equals(mPayMode)) {
                    Pay.payToAlipay(getActivity(), payOrderBean.getData().getSign(), ConfirmOrderFragment.this);
                } else if (Constants.PAY_WALLET.equals(mPayMode)) {
                    onSuccess();
                } else if (Constants.PAY_WEIXIN.equals(mPayMode)) {
                    Pay.payToWeiXin(getActivity(), payOrderBean.getData(), ConfirmOrderFragment.this);
                }
            }
        });
    }
