...
import com.axp.axpseller.dao.serialize.ClientConfigSerialize;
...
import com.axp.axpseller.models.config.LocalConfig;
import com.axp.axpseller.utils.AppUtils;
import com.axp.axpseller.utils.DeviceUtils;
...
public class ContextParameter {
    ...
    private static SellersInfo sellersInfo;
    /**
     * 当前的定位地址
     */
    ...
    static {
        ...
        setSellersInfo(SellerInfoSp.getSellersInfo());
...
//        Log.d("雨落无痕丶", "isLogin: "+getUserInfo().getAdminuserId());
        if (StringUtils.isBlank(getUserInfo().getAdminuserId())) {
            return false;
        } else {
            return true;
        }
...
//        return (int) s;
     ...
     * 当前登录的商家信息
     */
    public static SellersInfo getSellersInfo(){ return sellersInfo;}

    public static void setSellersInfo(SellersInfo sellersInfo){ ContextParameter.sellersInfo = sellersInfo;}
