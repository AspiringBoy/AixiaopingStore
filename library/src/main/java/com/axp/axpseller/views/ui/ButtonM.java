package com.axp.axpseller.views.ui;
...
public class ButtonM extends Button{
    ...
    private String backColors = "#FFFFFF";//背景色，String类型
    private int backColori = 0;//背景色，int类型
    private String backColorSelecteds = "#FFFFFF";//按下后的背景色，String类型
    ...
    private String textColors = "#000000";//文字颜色，String类型
    private int textColori = 0;//文字颜色，int类型
    private String textColorSeleteds = "#000000";//按下后的文字颜色，String类型
