...
public class LocalConfigSP {
    ...
    //打开新消息提示
    public static final String KEY_OPEN_NEW_MSG_NOTICE = "KEY_OPEN_NEW_MSG_NOTICE";

    //打开消息声音
    public static final String KEY_OPEN_VOICE = "KEY_OPEN_VOICE";
    ...
    public static void setLocalConfig(LocalConfig localConfig) {
        ...
        values.put(KEY_OPEN_NEW_MSG_NOTICE, localConfig.isOpenNewMsgNotice());
    ...
    public static LocalConfig getLocalConfig() {
        ...
        localConfig.setOpenNewMsgNotice(SPUtils.getValueByMapToBoolean(values, KEY_OPEN_NEW_MSG_NOTICE, localConfig.isOpenNewMsgNotice()));
