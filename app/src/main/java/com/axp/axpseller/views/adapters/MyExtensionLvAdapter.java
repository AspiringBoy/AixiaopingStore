 ...
 */
public class MyExtensionLvAdapter extends BaseAdapter {
    ...
    public MyExtensionLvAdapter(Context context, List<GoodsManageModel> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.cal_tv = (TextView) view.findViewById(R.id.cal_tv);
            holder.edt_tv = (TextView) view.findViewById(R.id.edt_tv);
        ...
        holder.cal_tv.setText("预览");
        holder.edt_tv.setText("删除");
                ...
                customDialog = DialogUtil.showCustomDialog(context, R.style.customDialogStyle, R.layout.remove_good_dialog_item, 270, 130, "是否要删除该商品?", R.id.dialog_msg_tv, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        switch (view.getId()) {
                            ...
                            case R.id.btn_sure:
                                customDialog.dismiss();
                                DataUtil.deleteGood(context, Constants.GOOD_MANAGE_SELLING_STATUS, model.getTypeId() + "", model.getBaseGoodsId(), model.getGoodsOrder(), updateListenner);
                                break;
                        }
                    }
    ...
    class MyHolder {
        ...
        TextView goodDesc, goodPrice, goodStock, goodSoldNum, price_type, good_type, good_type_price, cal_tv, edt_tv;
