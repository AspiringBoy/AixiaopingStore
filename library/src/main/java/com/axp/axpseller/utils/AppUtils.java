...
import com.axp.axpseller.core.WebActivity;
...
public class AppUtils {
    ...
    public static void toGoods(Context context, String goodsId) {
        try {
            if (goodsClass == null) {
                goodsClass = Class.forName("com.axp.axpseller.activitys.mall.mall.GoodsActivity");
            }
    ...
    public static void toGoods(Context context, String goodsId, boolean startSecondKill) {
        try {
            if (goodsClass == null) {
                goodsClass = Class.forName("com.axp.axpseller.activitys.mall.GoodsActivity");
            }
    ...
    public static void toSeller(Context context, String sellerId) {
        try {
            if (sellerClass == null) {
                sellerClass = Class.forName("com.axp.axpseller.activitys.mall.mall.SellerActivity");
            }
            Bundle bundle = new Bundle();
    ...
    public static void toGoodsExchange(Context context, String orderId, String exchangeCode ){
        try {
            if(goodsExchangeClass == null){
                goodsExchangeClass = Class.forName("com.axp.axpseller.activitys.sellerinfo.StayExchangeActivity");
            }
            Bundle bundle = new Bundle();
    ...
    public static void toShoppingCar(Context context) {
        try {
            if (homeClass == null) {
                homeClass = Class.forName("com.axp.axpseller.activitys.HomeActivity");
            }
            Bundle bundle = new Bundle();
